    ...
    render () {        
        ...
        return(
            <nav className="side-navbar box-scroll sidebar-scroll">
                <ul className="list-unstyled">
                    ...
                    <li>
                        <Link to="/Widgets" activeClassName="active">
                            <i className="la la-spinner"></i><span>Widgets</span>
                        </Link>
                    </li>
                </ul>
                ...
                <ul className="list-unstyled">
                    <li>
                        <a href="#dropdown-ui" aria-expanded="false" data-toggle="collapse">
                    ...
                    <li><a href="#dropdown-tables" aria-expanded="false" data-toggle="collapse"><i className="la la-th-large"></i><span>Tables</span></a>
                        <ul id="dropdown-tables" className="collapse list-unstyled pt-0">
                            <li><Link to="/Tables_Basic" activeClassName="active">Basic</Link></li>
